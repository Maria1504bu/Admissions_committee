...
class ApplicationTest {
    ...
    void setUp() {
        ...
        List grades = List.of(new Grade(new Subject(50, Arrays.asList("Math")), 123));
    ...
    @Test
    void setFaculty() {
        Faculty faculty = new Faculty(null, 12, 20);
        application.setFaculty(faculty);
        Assertions.assertEquals(new Faculty(null, 12, 20), application.getFaculty());
    }
    ...
    @Test
    void getGradesList() {
        Assertions.assertEquals(List.of(new Grade(new Subject(50, Arrays.asList("Math")), 123)), application.getGradesList());
    }

    @Test
    void setGradesList() {
        List newGrades = List.of(new Grade(new Subject(28, Arrays.asList("English")), 170));
