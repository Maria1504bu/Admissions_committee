...
class GradeTest {
    ...
    @BeforeEach
    void setup() {
        Subject subject = new Subject(38, List.of("Physic", "Фізика"));
    ...
    @Test
    void setSubject() {
        Subject subject = new Subject(47, List.of("Engineering"));
    ...
    void testEqualsFalse() {
        Subject subject = new Subject(32, List.of("Physic", "Фізика"));
